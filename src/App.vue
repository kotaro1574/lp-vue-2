      ...
      <main>
        ...
        <div class="service">
          ...
          <div class="service-content" v-for="(data, index) in service" :key="index">
            <div class="service-img" :class="data.class">
              <img :src="data.img" alt="" />
            </div>
            <div class="service-content_inner" :class="data.class2">
              <h3 class="mgb-15">{{data.topic}}</h3>
              <p class="mgb-15">{{data.title}}</p>
              <p class="mgb-15">
                {{data.description}}
              </p>
        ...
        <div class="company">
          <div class="recruit-company flex">
            <div class="recruit-company_size" v-for="(data, index) in company" :key="index" :class="data.classImg">
              <h2 class="company-title section-title">
                {{data.title}}<br /><span>{{data.description}}</span>
              </h2>
            </div>
          </div>
        </div>
...
export default {
  data() {
    return {
      service: [
        {
          ...
          topic: "web制作事業",
          title: "コーチングのミッション",
          description: "ユーザーが求める物を分析し、ユーザビリティを備えた最適なサイトを提供。建設業から美容、ブライダル、飲食店まで多種多様な業種の制作実績があります",
          btn: "サービス詳細"
        },
        {
          class: "service-img_second",
          class2: "service-content_inner-second",
      ...
      company: [
        {
          classImg: "company-img",
          title: "company",
          description: "会社概要"
        },
        {
          classImg: "recruit-img",
          title: "recruit",
          description: "採用情報"
        }
      ]
